            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblProdName" runat="server" Text="Select Product  "></asp:Label>
                            <br />
                         ...
                         <div class="form-group">
                            <label></label>
                             <asp:Button ID="Button1" runat="server" Text="Make Invoice"  
                                 class="btn btn-danger btn-lg btn-block" onclick="Button1_Click1" /> 
                             <br />
                        </div>
                                <asp:Panel ID="Panel1" runat="server">
                                  Product Name:  <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label><br />
                         Price:  <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label><br />
                           Quantity: <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label><br />
                                    <asp:Label ID="Label5" runat="server" Text="Final Bill"></asp:Label>
                                    <br />
