<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintExcel.aspx.cs" Inherits="PrintExcel" %>
...
<head id="Head1" runat="server">
    ...
    <title>ASP Admin Template : Two Page</title>
    <!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2> 
                            <asp:Button ID="Button1" runat="server" Text="Print Data"   
